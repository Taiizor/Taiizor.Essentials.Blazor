...
namespace Taiizor.Essentials.Blazor.Extension.Meta
{
    public class Viewport
    {
        ...
        {
            await Interop.Call("Taiizor.Meta.Viewport.Set", Content);
        }

        public static async ValueTask<string> Get()
        {
            return await Interop.CallString("Taiizor.Meta.Content", Internal.MetaNames[MetaEnum.Viewport]);
        }

        public static async ValueTask<bool> Check()
        {
            return await Interop.CallBool("Taiizor.Meta.Check", Internal.MetaNames[MetaEnum.Viewport]);
        }
        ...
        {
            await Interop.Call("Taiizor.Meta.Viewport.Remove", Execute);
        }
    }
}