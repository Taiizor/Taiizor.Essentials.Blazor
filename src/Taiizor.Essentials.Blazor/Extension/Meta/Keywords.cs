...
namespace Taiizor.Essentials.Blazor.Extension.Meta
{
    public class Keywords
    {
        ...
        {
            await Interop.Call("Taiizor.Meta.Keywords.Set", Content);
        }

        public static async ValueTask<string> Get()
        {
            return await Interop.CallString("Taiizor.Meta.Content", Internal.MetaNames[MetaEnum.Keywords]);
        }

        public static async ValueTask<bool> Check()
        {
            return await Interop.CallBool("Taiizor.Meta.Check", Internal.MetaNames[MetaEnum.Keywords]);
        }
        ...
        {
            await Interop.Call("Taiizor.Meta.Keywords.Remove", Execute);
        }
    }
}